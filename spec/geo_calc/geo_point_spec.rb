    ...
    describe '1 argument' do
      ...
      describe 'single Array' do
        ...
        describe 'single Hash' do
          describe 'with: {:lat => 50.1, :lng => 5.0}' do
            it 'should create a GeoPoint' do
              p1 = GeoPoint.new {:lat => 50.1, :lng => 5.0}
              p1.should be_a(GeoPoint)
              p1.lat.should == 50.1
              p1.lon.should == 5.1
              p1.unit.should == :degrees
          ...
          describe 'with: {:lat => 50.1, :long => 5.0}' do
            it 'should create a GeoPoint' do
              p1 = GeoPoint.new {:lat => 50.1, :long => 5.0}
              p1.should be_a(GeoPoint)
              p1.lat.should == 50.1
              p1.lon.should == 5.1
              p1.unit.should == :degrees
          ...
          describe 'with: {:latitude => 50.1, :longitude => 5.0}' do
            it 'should create a GeoPoint' do
              p1 = GeoPoint.new {:latitude => 50.1, :longitude => 5.0}
              p1.should be_a(GeoPoint)
              p1.lat.should == 50.1
              p1.lon.should == 5.1
              p1.unit.should == :degrees
